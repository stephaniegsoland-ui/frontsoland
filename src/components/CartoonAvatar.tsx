...
function GeneratedAvatar({ username, config = DEFAULT_AVATAR_CONFIG }: { username: string; config?: AvatarConfig }) {
  const hairMap: Record<string, string> = { corto: "shortRound", largo: "longButNotTooLong", rizado: "curly", bob: "bob", bun: "bun", curly: "fro" };
...
export function CartoonAvatar({ username, photoData, size = 160, config: providedConfig }: CartoonAvatarProps) {
